...
function MR:RunSelfTest()
    ...
    run("Main UI frame", function()
        if not self.frame then
            return "warn", "main frame not built yet (open with /routine show)"
        end
        return true
    end)
...
SlashCmdList["MIDROUTE"] = function(msg)
    ...
    elseif msg == "mem clear" or msg == "memory clear" then
        ...
        MR._professionKnowledgeWindowBuildCount = 0
        MR._professionKnowledgeWindowRenderCount = 0
        MR._professionKnowledgeWindowRefreshRequestCount = 0
        MR._professionKnowledgePooledFrameCreatedCount = 0
        MR._professionKnowledgePooledLabelCreatedCount = 0
        MR._professionKnowledgePooledTextureCreatedCount = 0
        MR._professionKnowledgePooledFrameReusedCount = 0
        MR._professionKnowledgePooledLabelReusedCount = 0
        MR._professionKnowledgePooledTextureReusedCount = 0
        MR._raresWindowBuildCount = 0
        MR._raresWindowRebuildCount = 0
        MR._raresWindowLayoutCount = 0
        MR._raresWindowRefreshCount = 0
        MR._renownWindowBuildCount = 0
        MR._renownWindowRebuildCount = 0
        MR._renownWindowRefreshCount = 0
        MR._mainRowWidgetReusedCount = 0
        MR._mainRowWidgetPooledCount = 0
        MR._mainRowOptionalPartCreatedCount = 0
        MR._mainSectionWidgetCreatedCount = 0
        MR._mainSectionWidgetReusedCount = 0
        MR._mainSectionWidgetPooledCount = 0
        MR._mainViewportRefreshCount = 0
