...
local function BuildWelcomeScreen()
    ...
    titleTxt:SetText(ns.StripColorCodes(L["Welcome_Title"]))
    ns.RegisterThemedFontString(titleTxt, 0.78, 0.96, 0.98)
    ...
    ns.RegisterThemedFontString(layoutLabel, 0.72, 0.92, 0.90)
    ...
    thumb:SetScript("OnEnter", function()
        local r, g, b = ns.ResolveThemeColor(0.36, 0.86, 0.82)
        thumbTex:SetColorTexture(r, g, b, 0.95)
    end)
    thumb:SetScript("OnLeave", function()
        local r, g, b = ns.ResolveThemeColor(0.24, 0.72, 0.72)
        thumbTex:SetColorTexture(r, g, b, 0.82)
    end)
    ...
    local function BuildSectionHeader(text)
        ...
        ns.RegisterThemedTexture(line, 0.16, 0.78, 0.75, 0.22)
        ...
        fs:SetJustifyH("LEFT")
        fs:SetText(text)
        ns.RegisterThemedFontString(fs, 0.72, 0.92, 0.90)
        yOff = yOff - 26
    end
    ...
    ns.ThemeCheckButton(suppressCb)
