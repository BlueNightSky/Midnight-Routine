...
local function BuildRenownFrame()
    ...
    for i, faction in ipairs(GetOrderedFactions()) do
        ...
        fallbackLabel:SetFont(ns.FONT_HEADERS, 14, GetFontFlags())
        ...
        levelLabel:SetFont(ns.FONT_ROWS, 8, GetFontFlags())
        ...
        nameLabel:SetFont(ns.FONT_HEADERS, math.max(10, fontSize + 2), GetFontFlags())
        ...
        renownLabel:SetFont(ns.FONT_ROWS, fontSize, GetFontFlags())
        ...
        barLabel:SetFont(ns.FONT_ROWS, fontSize, GetFontFlags())
        if compact then
        ...
        compactLevelLabel:SetFont(ns.FONT_ROWS, math.max(8, fontSize - 1), GetFontFlags())
...
PopulateRenownConfig = function(f)
    ...
    for _, faction in ipairs(ordered) do
        ...
        gripLbl:SetFont(ns.FONT_HEADERS, 11, GetFontFlags())
