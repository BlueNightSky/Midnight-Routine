...
local ZONES = {
    ...
    MR:IsPatchAvailable("12.0.7") and {
        ...
        rares = {
            { L["Rare_InterminableUarn"] or "Interminable Uarn", nil, 2600, 37.45, 63.20, 263947 },
            { L["Rare_SwalewingMatriarch"] or "Swalewing Matriarch", nil, 2600, 77.91, 38.62, 263954 },
            { L["Rare_Auredar"] or "Auredar", nil, 2600, 28.08, 50.52, 264569 },
            { L["Rare_IndomitableMkXII"] or "Indomitable Mk XII", nil, 2600, 53.07, 54.98, 264571 },
            { L["Rare_Broxion"] or "Broxion", nil, 2600, 43.66, 50.44, 263950 },
            ...
            { L["Rare_Slaipaan"] or "Slaipaan", nil, 2600, 57.03, 60.24, 264576 },
    ...
    MR:IsPatchAvailable("12.0.7") and {
        ...
        rares = {
            { L["Rare_SleetRune"] or "Sleet-Rune", nil, 2599, 61.68, 78.91, 261965 },
            { L["Rare_GlacialBroodmother"] or "Glacial Broodmother", nil, 2599, 56.13, 49.98, 261716 },
            { L["Rare_Xirah"] or "Xirah", nil, 2599, 29.12, 73.90, 264864 },
            { L["Rare_Opprimius"] or "Opprimius", nil, 2599, 35.32, 38.89, 264868 },
            { L["Rare_TheHorrorBelow"] or "The Horror Below", nil, 2599, 43.32, 70.90, 264870 },
            { L["Rare_Atomus"] or "Atomus", nil, 2599, 37.92, 76.25, 262421 },
            { L["Rare_Mercilus"] or "Mercilus", nil, 2599, 49.66, 78.58, 264865 },
            { L["Rare_Krilkan"] or "Krilkan", nil, 2599, 46.23, 48.41, 264866 },
            { L["Rare_Nelgothar"] or "Nelgothar", nil, 2599, 30.41, 38.64, 264869 },
            { L["Rare_ShadowguardDestroyer"] or "Shadowguard Destroyer", nil, 2599, 46.48, 59.56, 265269 },
        },
    } or nil,
    MR:IsPatchAvailable("12.1.0") and {
        ...
        rares = {
            { L["Rare_Farthik"] or "Farthik the Plunderer", 96491, 2512, 53.78, 72.06 },
            { L["Rare_Siltmouth"] or "Siltmouth", 97112, 2512, 50.25, 69.27 },
            { L["Rare_Karizah"] or "Kari'zah the Forgotten", 97122, 2512, 24.93, 73.70 },
            { L["Rare_Lockjaw"] or "Lockjaw", 96456, 2512, 31.78, 56.70 },
            { L["Rare_Hisstara"] or "Hisstara", 96464, 2512, 44.15, 50.39 },
            { L["Rare_Szarith"] or "Szarith the Fanged", 96030, 2512, 45.72, 64.94 },
            { L["Rare_Garsecg"] or "Garsecg", 94856, 2512, 69.44, 44.85 },
            { L["Rare_Narzira"] or "Nar'zira", 94860, 2512, 52.37, 43.10 },
            { L["Rare_CoinEyeSkully"] or "Coin-Eye Skully", 94619, 2512, 57.29, 68.47 },
            { L["Rare_BigMon"] or "Big Mon", 93829, 2512, 69.92, 63.49 },
            { L["Rare_Sssalik"] or "Sss'alik", 95447, 2512, 57.37, 40.17 },
            { L["Rare_Destra"] or "Destra", 95452, 2512, 52.27, 32.43 },
        },
    } or nil,
}
